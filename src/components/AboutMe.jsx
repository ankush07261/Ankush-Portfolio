...
function AboutMe() {
  return (
    ...
    <div className='aboutMe-container'>
      <div className="text">
        <p className='me-text'> 
            <b><a className="resume" href="https://drive.google.com/file/d/13BTsAWkr3Z21S1OxCDkKingAleNKJRWx/view?usp=sharing" target="_blank" rel="noreferrer"> Click here to view my resume</a></b><br /><br />
